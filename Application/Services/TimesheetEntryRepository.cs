...
// TODO: methods  do not yet allow searching by user, week, etc.
...
{
    private readonly List<TimesheetEntry> _listTimesheetEntries = new List<TimesheetEntry>();

    // Private counter used to generate unique Ids for new entries mirroring DB auto-increment.
    // Avoid scanning list for highest Id 
    // Also if highest row was deleted we do not want to reuse that ID.
